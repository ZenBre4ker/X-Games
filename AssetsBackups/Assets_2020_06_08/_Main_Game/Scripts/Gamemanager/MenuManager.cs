...
public enum sceneNames {Introduction,Main_Menu,Multiplayer_Lobby, Game_Lobby, Multiplayer_Host, Multiplayer_Join, DotsNBoxes};
public class MenuManager : MonoBehaviour
{
    ...
    void changeScene(sceneNames scene)
    {
        ...
        if (_nM.isSinglePlayer || _nM.isHost || packetOverride)
        {
            if (_nM.isHost && !_nM.isSinglePlayer)
            {
